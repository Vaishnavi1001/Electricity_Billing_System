...
public class Home extends JFrame implements ActionListener{
    ...
    Home(String atype, String meter) {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("bill.jpg"));
        ...
        mb.setBackground(new Color(49, 48, 77));
        setJMenuBar(mb);
        
        JMenu master = new JMenu("Administrator");
        master.setFont(new Font("Helvetica", Font.BOLD, 25));
        master.setForeground(Color.white);
        
        
        JMenuItem newcustomer = new JMenuItem("New Customer");
        newcustomer.setFont(new Font("Helvetica", Font.BOLD, 15));
        ...
        customerdetails.setFont(new Font("Helvetica", Font.BOLD, 15));
        ...
        calculatebill.setFont(new Font("Helvetica", Font.BOLD, 15));
        ...
        info.setFont(new Font("Helvetica", Font.BOLD, 25));
        info.setForeground(Color.white);
        
        
        JMenuItem viewinformation = new JMenuItem("View Information");
        viewinformation.setFont(new Font("Helvetica", Font.BOLD, 15));
