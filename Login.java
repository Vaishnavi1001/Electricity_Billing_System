...
public class Login extends JFrame implements ActionListener{
    ...
    Login() {
        super("Login Page");
        getContentPane().setBackground(new Color(82, 211, 216));
        setLayout(null);
        
        JLabel lblusername = new JLabel("Username");
        lblusername.setBounds(350, 120, 100, 20);
        lblusername.setFont(new Font("Helvetica", Font.BOLD, 14));
        add(lblusername);
        ...
        login.setBackground(new Color(238, 245, 255));
        login.addActionListener(this);
        add(login);
        
        cancel = new JButton("Cancel");
        cancel.setBounds(450, 350, 100, 40);
        cancel.setBackground(new Color(238, 245, 255));
        cancel.addActionListener(this);
        add(cancel);
        
        signup = new JButton("Signup");
        signup.setBackground(new Color(238, 245, 255));
